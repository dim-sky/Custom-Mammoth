"""
Linear Classifier with TRAINABLE Backbone
...
class TrainableBackboneLinearPretrained(ContinualModel):
    """Linear classifier with trainable pretrained backbone"""
    NAME = 'trainable_backbone_linear_pretrained'
    ...
    def _setup_differential_lr(self):
        """
        Setup optimizer with different learning rates for backbone vs classifier.
        
        This is CRITICAL for trainable backbone!
        - Backbone: Small LR (fine-tune pretrained features)
        - Classifier: Large LR (learn new classes from scratch)
        """
