...
Inherits from KAN baseline and adds LwF functionality
"""
...
from models.trainable_backbone_kan_pretrained import TrainableBackboneKANPretrained
from utils.args import ArgumentParser


class TrainableBackboneKANLwF(TrainableBackboneKANPretrained):
    ...
    def __init__(self, backbone: torch.nn.Module, loss: torch.nn.Module,
        ...
        # Call KAN parent to get KAN classifier + differential LR setup
        ...
        print(f"\n{'='*70}")
        print(f"[Trainable-LwF-KAN] Learning without Forgetting enabled")
        print(f"[Trainable-LwF-KAN] Classifier type: {type(self.net.classifier)}")
        print(f"{'='*70}\n")
