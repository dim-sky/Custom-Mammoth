"""
KAN Classifier with TRAINABLE Backbone
...
class TrainableBackboneKANPretrained(ContinualModel):
    """KAN classifier with trainable pretrained backbone"""
    NAME = 'trainable_backbone_kan_pretrained'
