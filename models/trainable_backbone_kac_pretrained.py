"""
KAC Classifier with TRAINABLE Backbone
...
class TrainableBackboneKACPretrained(ContinualModel):
    """KAC classifier with trainable pretrained backbone"""
    NAME = 'trainable_backbone_kac_pretrained'
    ...
    def get_parser(parser):
        ...
        # KAC-specific arguments will be inherited from baseline KAC model
        return parser